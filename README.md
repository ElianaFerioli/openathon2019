...
Se trata de un tipo de orquestación de stacks de contenedores. Cuando queremos gestionar distintos servicios que tienen que interactuar entre sí, 
...
> ```
> Si todo ha ido bien, se mostrará ula versión instalada de docker-compose.
<br/>
